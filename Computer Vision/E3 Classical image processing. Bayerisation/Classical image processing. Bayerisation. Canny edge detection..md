...
**Общий конвейер для сегментации**
- - установка пороговых значений для бинаризации с помощью фильтра Otsu
- заполнение небольших зашумленных точек морфологическим закрытием
- удаление артефактов границ (пересечение объектов)
- фильтрация небольших объектов по квадрату
