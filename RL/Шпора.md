...
- **GAE** (generalised advantage estimation)
	...
	- A higher $\lambda$ places more emphasis on longer-term rewards, and a lower $\lambda$ prioritises short-term advantages.
...
- **REINFORCE**
	- Steps
		...
		- **Collect samples**: For each episode, interact with the environment by following the current policy. Collect the sequence of states, actions, and rewards.
