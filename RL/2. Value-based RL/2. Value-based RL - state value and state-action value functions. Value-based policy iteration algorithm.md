...
[[Грокаем_глубокое_обучение_с_подкреплением_NdMAJD.pdf | По книжке, со страницы 99]], гораздо подробнее это описано. Сначала объясняется как считать V-функцию - формула:
